...
AD_CONSOLIDADO = [
    ...
    "TITLE", "DEPARTMENT", "COMPANY", "STREETADDRESS", "ORIGEN", "OFFICE"
]
...
ROL_TICKET = [
    "ELEMENTO DE SOLICITUD","ELEMENTO", "ESCOGE UNA OPCION", "NÚMERO DE DOCUMENTO", 
    "DESCRIPCION BREVE", "ROL ASIGNADO", "NUMERO DE DOCUMENTO", "DNI", "¿QUE ROL SE CREARA?",
    "¿QUE ROL SE LE ASIGNARA?", "CREADO", "CERRADO"
]
