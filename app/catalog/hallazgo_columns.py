...
AD_ROWS: list[ColumnDef] = [
    ...
    Col("title", "Title", "C1", 120),
    Col("department", "Departamento", "C1", 124),
    Col("company", "Company", "C1", 120),
    Col("office", "Office", "C1", 150),
    Col("street_address", "Street Address", "C1", 120),
    Col("is_active", "Estado", "C1", 110),
    Col("fecha_ultimo_login_ad", "Último Login AD", "C1", 150, es_fecha=True),
    ...
    Col("fecha_cierre_ticket_cese", "Fecha Cierre Ticket", "C6", 150, es_fecha=True),
    Col("escenario", "Escenario", "C6", 200),
    Col("correo", "Correo Manual", "C6", 180),
...
PROFILE_ROWS: list[ColumnDef] = [
    ...
    Col("ticket_manual", "Ticket Manual", "C8", 150),
